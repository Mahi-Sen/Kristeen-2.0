...
async def give_filter(client, message):
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔍 ᴊᴏɪɴ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=f"https://t.me/Mahi_Movie_Request")]]))
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ 👇\n\n आपको यह फिल्म हमारी रिक्वेस्ट ग्रुप में सर्च करनी होगी तभी आपको यह फिल्म मिलेगी</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/Mahi_Movie_Request")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/Mahi_Movie_Request")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        try:
            ...
            if await db.has_premium_access(user_id):                               
                buttons = [[
                    ...
                    InlineKeyboardButton("🎥 ᴡᴀᴛᴄʜ ᴏɴʟɪɴᴇ 🖥️", url=lazy_stream)
                ],[
                    InlineKeyboardButton('🍿 ᴜᴘᴅᴀᴛᴇs 🎥', url='https://t.me/Radhe_Krishn_Movies')
                ]]
            else:
                ...
                buttons = [[
                    InlineKeyboardButton("⭐ ғᴀsᴛ ᴅᴏᴡɴʟᴏᴀᴅ 🚀", url=hp_link),
                    InlineKeyboardButton("🎥 ᴡᴀᴛᴄʜ ᴏɴʟɪɴᴇ 🖥️", url=ph_link)
                ],[
                    InlineKeyboardButton('⁉️ ʜᴏᴡ ᴛᴏ ᴏᴘᴇɴ ʟɪɴᴋ ⁉️', url=STREAMHTO)
                ]]
            ...
            await log_msg.reply_text(
                    ...
                    quote=True,
                    disable_web_page_preview=True,
                    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⭐ ғᴀsᴛ ᴅᴏᴡɴʟᴏᴀᴅ 🚀", url=hp_link),
                                                        InlineKeyboardButton('🎥 ᴡᴀᴛᴄʜ ᴏɴʟɪɴᴇ 🖥️', url=ph_link)]]))  
        except Exception as e:
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=f"{OWNER_ID}")
        ],[
        ...
        btn = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=f"{OWNER_ID}")
        ],[
    ...
    # Thanks to @CoderluffyTG for fixing this 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('• 1 ᴡᴇᴇᴋ •', callback_data='broze'),
            InlineKeyboardButton('• 1 ᴍᴏɴᴛʜ •', callback_data='silver')
        ],[
            InlineKeyboardButton('• 2 ᴍᴏɴᴛʜ •', callback_data='threemoth'),
            InlineKeyboardButton('• 3 ᴍᴏɴᴛʜ •', callback_data='gold')
        ],[
            InlineKeyboardButton('• 6 ᴍᴏɴᴛʜ •', callback_data='platinum'),
            InlineKeyboardButton('• 1 ʏᴇᴀʀ •', callback_data='diamond')
        ],[
            InlineKeyboardButton('• 10 ʏᴇᴀʀ •', callback_data='lifenxt'),
            InlineKeyboardButton('• ʟɪғᴇᴛɪᴍᴇ •', callback_data='leferee')
        ],[
            InlineKeyboardButton('• ᴄᴜsᴛᴏᴍ •', callback_data='other')
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('1 / 10', callback_data='pagesn1'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('2 / 10', callback_data='pagesn1'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('3 / 10', callback_data='pagesn1'),
    ...
    elif query.data == "threemoth":
        buttons = [[
            InlineKeyboardButton('🔐 ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', callback_data='purchase')
        ],[
            InlineKeyboardButton('⋞ ʙᴀᴄᴋ', callback_data='silver'),
            InlineKeyboardButton('4 / 10', callback_data='pagesn1'),
            InlineKeyboardButton('ɴᴇxᴛ ⋟', callback_data='gold')
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.THREE_MOTH_TXT .format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⋞ ʙᴀᴄᴋ', callback_data='threemoth'),
            InlineKeyboardButton('5 / 10', callback_data='pagesn1'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('6 / 10', callback_data='pagesn1'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('7 / 10', callback_data='pagesn1'),
            InlineKeyboardButton('ɴᴇxᴛ ⋟', callback_data='lifenxt')
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    elif query.data == "lifenxt":
        buttons = [[
            InlineKeyboardButton('🔐 ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', callback_data='purchase')
        ],[
            InlineKeyboardButton('⋞ ʙᴀᴄᴋ', callback_data='diamond'),
            InlineKeyboardButton('8 / 10', callback_data='pagesn1'),
            InlineKeyboardButton('ɴᴇxᴛ ⋟', callback_data='leferee')
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.LIFE_NXTTXT.format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )

    elif query.data == "leferee":
        buttons = [[
            InlineKeyboardButton('🔐 ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', callback_data='purchase')
        ],[
            InlineKeyboardButton('⋞ ʙᴀᴄᴋ', callback_data='lifenxt'),
            InlineKeyboardButton('9 / 10', callback_data='pagesn1'),
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.LIFE_RIME.format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        buttons = [[
            InlineKeyboardButton('☎️ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', user_id=f"{OWNER_ID}")
        ],[
            InlineKeyboardButton('⋞ ʙᴀᴄᴋ', callback_data='leferee'),
            InlineKeyboardButton('10 / 10', callback_data='pagesn1'),
        ...
        buttons = [[
            InlineKeyboardButton('⚜️ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ ⚜️', url='https://t.me/Radhe_Krishn_Movies')
        ],[
            InlineKeyboardButton('🔍 ɢʀᴏᴜᴘ¹', url='https://t.me/Mahi_Movie_Request'),
            InlineKeyboardButton('ɢʀᴏᴜᴘ² 🔎', url='https://t.me/Movvies_Request')
        ],[
            InlineKeyboardButton('✉️ ʀᴇǫᴜᴇꜱᴛ ɢʀᴏᴜᴘ ✉️', url='https://t.me/ALL_Movie_Request_Group_HD')
        ],[
            InlineKeyboardButton('⇇ ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ 👮', url='https://t.me/MS_Contact_RoBot')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⇇ ʙᴀᴄᴋ', callback_data='about'),
            InlineKeyboardButton('♻️ ʀᴇғʀᴇsʜ ♻️', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f'Seaching for {search} 🔎', url=f"https://t.me/Mahi_Movies")]]) 
            )
            search = search.lower()
            find = search.split(" ")
            search = ""
    ...
    if imdb:
        ...
        if settings["button"]:
            ...
            for file in files:
                cap += f"<b><a href='https://telegram.me/{temp.U_NAME}?start=files_{file.file_id}'> ▫️ {get_size(file.file_size)} ➜ {' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@') and not x.startswith('www.'), file.file_name.split()))}\n\n</a></b>"
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        if not g_s:
            ...
            button = [[
                       InlineKeyboardButton("📝 ʀᴇǫᴜᴇꜱᴛ ʜᴇʀᴇ", url=f"https://t.me/Mahi_Movie_Request")
            ]]
            if NO_RESULTS_MSG:
